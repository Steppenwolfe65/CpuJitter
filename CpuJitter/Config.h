...
const int CEX_VERSION_MINOR = 1;
const int CEX_VERSION_RELEASE = 13; // m series
const int CEX_VERSION_PATCH = 0;

// compiler types; not all will be supported (target is msv, mingw, gcc, and clang)
#if defined(_MSC_VER)
