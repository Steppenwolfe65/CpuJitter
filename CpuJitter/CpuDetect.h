...
namespace CpuJitter
{
	...
	private:
		...
		static constexpr size_t KB1 = 1024;
		static constexpr size_t KB32 = 32 * 1024;
		static constexpr size_t KB128 = 128 * 1024;
		static constexpr size_t KB256 = 256 * 1024;
	...
	public:
		...
		{
			if (m_l1CacheLineSize == 0 || m_l1CacheLineSize == 0)
				return 64;
			else
